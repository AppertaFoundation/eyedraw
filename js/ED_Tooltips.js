...
ED.trans['DiskHaemorrhage'] = 'Disk haemorrhage<br/><br/>Drag to position';
...
ED.trans['OpticDisk'] = 'Optic disk<br/><br/>Basic mode: Drag handle to adjust cup/disk ratio<br/>Expert mode: Drag handles to re-shape disk';
ED.trans['OpticDiskPit'] = 'Optic disk pit<br/><br/>Drag to position<br/>Drag handle to change shape';
...
ED.trans['PI'] = 'Peripheral iridectomy<br/><br/>Drag to move around the limbus';
