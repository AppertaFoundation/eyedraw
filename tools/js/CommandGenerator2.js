...
(function(App){
	...
	var CommandGenerator = function(xInput, yInput, scaleInput, output){
		this.init(xInput, yInput, scaleInput, output);
	};
	...
	CommandGenerator.prototype = {
		...
		init: function(xInput, yInput, scaleInput, output){
			this.setInputComponents(xInput, yInput, scaleInput, output);
		},
		...
		generateCanvasCommands: function(){
			...
			this.$output.val(commands).trigger('input');
		...
		setInputComponents: function(xInput, yInput, scaleInput, output){
