...
class OEEyeDrawWidgetVitrectomy extends OEEyeDrawWidget {
	public $doodleToolBarArray = array('RRD','UTear','RoundHole','Dialysis','GRT','MacularHole','StarFold','AntPVR','Cryo','LaserCircle');
	public $size = 300;
